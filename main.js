...
for(var i=0; i < activeProjects.length; i++){
	...
	var textToCopy = btoa(JSON.stringify({
		saveGame: saveGame,
		projectsUses: projectsUses,
		projectsFlags: projectsFlags,
		projectsActive: projectsActive,
		stratsActive: stratsActive
	}));
...
function load1() {
	...
	var load = JSON.parse(atob(prompt('Enter save game:')));
	
	var loadGame = load.saveGame;
	var loadProjectsUses = load.projectsUses;
	var loadProjectsFlags = load.projectsFlags;
	var loadProjectsActive = load.projectsActive;
	var loadStratsActive = load.stratsActive;
